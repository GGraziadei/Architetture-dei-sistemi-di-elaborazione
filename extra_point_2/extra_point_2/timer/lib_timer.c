...
{
	switch( timer_num ) {
		case 0 : LPC_TIM0->TCR = 1; return;
		case 1 : LPC_TIM1->TCR = 1; return;
		case 2 : LPC_TIM2->TCR = 1; return;
		case 3 : LPC_TIM3->TCR = 1; return;
		default : return;
	}
...
{
  switch( timer_num ) {
		case 0 : LPC_TIM0->TCR = 0; return;
		case 1 : LPC_TIM1->TCR = 0; return;
		case 2 : LPC_TIM2->TCR = 0; return;
		case 3 : LPC_TIM3->TCR = 0; return;
		default : return;
	}
}
...
uint32_t tc_timer( uint8_t timer_number ){
	
	switch( timer_number ) {
		case 0 : return LPC_TIM0->TC ;
		case 1 : return LPC_TIM1->TC ;
		case 2 : return LPC_TIM2->TC ;
		case 3 : return LPC_TIM3->TC ;
